...
class FrameHeader:
    STRUCT_FORMAT = '<IIIIIIII'  # Excluding sync pattern, adjust if necessary

    def __init__(self, sync, data):
        # Assuming sync is already read and data starts immediately after sync
    ...
    def __str__(self):
        return (f"FrameHeader(sync={self.sync!r}, "
